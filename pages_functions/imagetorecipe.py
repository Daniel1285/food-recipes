...
import model
class ImageToRecipe(QWidget, QtCore.QObject):
    """
    Widget for selecting a recipe based on an input image.

    Attributes:
        recipeSelected (Signal): Signal emitted when a recipe is selected.
    """
    ...
    def __init__(self):
        """
        Initialize the Image_to_recipe widget.
        """
        super(ImageToRecipe, self).__init__()
        self.ui = Ui_Form()
    ...
    def add_buttons(self):
        """
        Add buttons based on the input image.
        """
    ...
    def is_clicked(self):
        """
        Emit signal when the 'Get Recipe' button is clicked.
        """
